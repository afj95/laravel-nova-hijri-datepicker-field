...
/***/ "./resources/js/datepicker-hijri.js":
/*!******************************************!*\
  !*** ./resources/js/datepicker-hijri.js ***!
  \******************************************/
...
(function () {
  ...
  if (!currentScript || !currentScript.hasAttribute('nomodule') || !('onbeforeload' in currentScript)) {
     ...
     * @return {string}
     */
    var clean = function clean(cssText) {
     ...
     * @return {StyleNode}
     */
    var parseCss = function parseCss(node, text) {
     ...
     * @return {string}
     */
    var _expandUnicodeEscapes = function _expandUnicodeEscapes(s) {
    ...
    /** @enum {number} */
    var findRegex = function findRegex(regex, cssText, offset) {
      regex['lastIndex'] = 0;
    ...
    var resolveVar = function resolveVar(props, prop, fallback) {
      if (props[prop]) {
        return props[prop];
      }
      if (fallback) {
    ...
    var findVarEndIndex = function findVarEndIndex(cssText, offset) {
      var count = 0;
      var i = offset;
    ...
    var parseVar = function parseVar(cssText, offset) {
    ...
    var compileVar = function compileVar(cssText, template, offset) {
    ...
    var executeTemplate = function executeTemplate(template, props) {
      var _final = '';
    ...
    var findEndValue = function findEndValue(cssText, offset) {
      var onStr = false;
      var _double = false;
      var i = offset;
      for (; i < cssText.length; i++) {
    ...
    var removeCustomAssigns = function removeCustomAssigns(cssText) {
      var _final2 = '';
      var offset = 0;
      while (true) {
    ...
    var compileTemplate = function compileTemplate(cssText) {
      var index = 0;
    ...
    var resolveValues = function resolveValues(selectors) {
      var props = {};
    ...
    var getSelectors = function getSelectors(root, index) {
      if (index === void 0) {
        index = 0;
      }
      if (!root.rules) {
    ...
    var computeSpecificity = function computeSpecificity(_selector) {
      return 1;
    };
    var getDeclarations = function getDeclarations(cssText) {
      var declarations = [];
      var xArray;
    ...
    var getActiveSelectors = function getActiveSelectors(hostEl, hostScopeMap, globalScopes) {
    ...
    var getScopesForElement = function getScopesForElement(hostTemplateMap, node) {
      var scopes = [];
      while (node) {
    ...
    var getSelectorsForScopes = function getSelectorsForScopes(scopes) {
      var selectors = [];
    ...
    var sortSelectors = function sortSelectors(selectors) {
    ...
    var parseCSS = function parseCSS(original) {
    ...
    var addGlobalStyle = function addGlobalStyle(globalScopes, styleEl) {
    ...
    var updateGlobalScopes = function updateGlobalScopes(scopes) {
    ...
    var reScope = function reScope(scope, scopeId) {
    ...
    var replaceScope = function replaceScope(original, oldScopeId, newScopeId) {
      original = replaceAll(original, "\\." + oldScopeId, "." + newScopeId);
      return original;
    };
    var replaceAll = function replaceAll(input, find, replace) {
      return input.replace(new RegExp(find, 'g'), replace);
    };
    var loadDocument = function loadDocument(doc, globalScopes) {
      loadDocumentStyles(doc, globalScopes);
      return loadDocumentLinks(doc, globalScopes);
    };
    var startWatcher = function startWatcher(doc, globalScopes) {
    ...
    var loadDocumentLinks = function loadDocumentLinks(doc, globalScopes) {
      var promises = [];
    ...
    var loadDocumentStyles = function loadDocumentStyles(doc, globalScopes) {
    ...
    var addGlobalLink = function addGlobalLink(doc, globalScopes, linkElm) {
    ...
    // start with "--").
    var hasCssVariables = function hasCssVariables(css) {
      return css.indexOf('var(') > -1 || CSS_VARIABLE_REGEXP.test(css);
    }; // This regexp find all url() usages with relative urls
    var hasRelativeUrls = function hasRelativeUrls(css) {
      CSS_URL_REGEXP.lastIndex = 0;
      return CSS_URL_REGEXP.test(css);
    };
    var fixRelativeUrls = function fixRelativeUrls(css, originalUrl) {
    ...
    var needsShim = function needsShim() {
    ...
    */
    !function (t, e) {
      ...
      function D() {
        var t = void 0;
        if ("undefined" != typeof __webpack_require__.g) t = __webpack_require__.g;else if ("undefined" != typeof self) t = self;else try {
      ...
      var L = K,
        ...
        Q = new Array(1e3),
        R = void 0;
      R = I ? o() : H ? s() : J ? u() : void 0 === B && "function" == "function" ? f() : c();
    ...
    !function (undefined) {
      ...
      !function (t) {
        ...
        t.exports = e((typeof globalThis === "undefined" ? "undefined" : _typeof(globalThis)) == n && globalThis) || e((typeof window === "undefined" ? "undefined" : _typeof(window)) == n && window) || e((typeof self === "undefined" ? "undefined" : _typeof(self)) == n && self) || e((typeof __webpack_require__.g === "undefined" ? "undefined" : _typeof(__webpack_require__.g)) == n && __webpack_require__.g) || Function("return this")();
      }, function (t, r, n) {
        var e = n(1);
    ...
    */
    ...
    !function () {
      var e = "undefined" != typeof self,
        n = e ? self : __webpack_require__.g;
      var t;
          ...
          var n = function e(n, t, r) {
            ...
            var l = Promise.resolve().then(function () {
              ...
              var r = e[1](function (e, n) {
                o.h = !0;
                var t = !1;
                if ("object" != _typeof(e)) e in s && s[e] === n || (s[e] = n, t = !0);else for (var n in e) {
                  var r = e[n];
    ...
    */
    ...
    var start = function start() {
      var url = new URL('./datepicker-hijri.js', resourcesUrl);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkafj95_laravel_nova_hijri_datepicker_field"] = self["webpackChunkafj95_laravel_nova_hijri_datepicker_field"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["css/field"], () => (__webpack_require__("./resources/js/datepicker-hijri.js")))
